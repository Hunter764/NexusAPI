...
import { Menu, X, Check, Hexagon } from "lucide-react";
...
export const SignInPage = ({ className }: SignInPageProps) => {
  ...
  const [step, setStep] = useState<"token" | "success">("token");
  ...
  const handleTokenSubmit = (e: React.FormEvent) => {
    ...
    if (tokenInput.trim().length > 0) {
      // Store token
      localStorage.setItem("nexus_token", tokenInput.trim());
                  ...
                  >
                      ...
                      <form onSubmit={handleTokenSubmit}>
                        <div className="relative">
                          <input
                            ...
                            className="w-full backdrop-blur-[1px] text-white border border-white/10 rounded-full py-3 px-4 focus:outline-none focus:border focus:border-white/30 text-center text-sm font-mono tracking-tight"
                            required
                          />
                          <button
                            type="submit"
                    ...
                    <div className="pt-10">
                      <div className="p-4 rounded-xl border border-white/10 bg-white/5 text-left space-y-2">
                        ...
                        <p className="text-sm text-white/70">
                          3. Paste it above to enter the Dashboard.
                        </p>
                      </div>
                    </div>
                  </motion.div>
